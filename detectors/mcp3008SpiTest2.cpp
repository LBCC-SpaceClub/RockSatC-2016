...
float testSampleRate(unsigned long numSamples=1000)
{
    cout << "Calculating...";
    clock_t timer = clock();
	...
	// second byte transmitted -> (SGL/DIF = 1, $
        ...
        a2dVal = 0;
                ...
                a2dVal |=  (data[2] & 0xff);
        // this test function simply ignores the results and only cares about runtime
    }
    timer = clock() - timer;
    cout << "Done.";
...
int main(void)
{
  float run1 = testSampleRate(100000);
  cout << run1;
  return 0;
}
